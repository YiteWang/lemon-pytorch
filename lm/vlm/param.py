...
def process_args():
    ...
    parser.add_argument(
        "--eval-when-log", action="store_true",
        help="Perform evaluation when log")
    ...
    parser.add_argument("--sched", default="linear", choices=['cosine', 'linear', 'poly', 'udfcosine', 'twostagelinear', 'linearnonzero'], help='LR scheduler')
    parser.add_argument("--poly", default=2, type=int, help='Polynomial of poly scheduler')
    parser.add_argument("--lr-decay", default=0.1, type=float, 
        help="The final decayed learning rate (in fraction w.r.t initial lr) for Adam.")
    parser.add_argument("--fast-decay-steps", default=10, type=int, 
        help="The initial fast-decayed learning rate steps for Adam.")
    parser.add_argument("--offset-steps", default=0, type=int, 
        help="The offset steps for lr scheduler, note that we will also add offset-steps to total steps.")
