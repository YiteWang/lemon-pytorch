...
from preln_bert import modBertForSequenceClassification
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        print('Evaluation results of {}: {}'.format(eval_task, result))
...
def main():
    ...
    model = modBertForSequenceClassification.from_pretrained(
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        model = modBertForSequenceClassification.from_pretrained(args.output_dir)
        while True:
            try:
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            model = modBertForSequenceClassification.from_pretrained(checkpoint)
            model.to(args.device)
